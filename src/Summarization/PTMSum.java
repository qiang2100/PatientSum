...
public class PTMSum {
	...
	public PTMSum(double alpa, double min_sup)
	{
		this.alpa = alpa;
		this.min_sup = min_sup;
	}
	
	public PTMSum(double alpa, double min_sup, double belt)
	{
		this.alpa = alpa;
	...
	public static void main(String[] args) {
		...
		try
		{
			MaxentTagger tagger = new MaxentTagger("C:/Users/Administrator/Dropbox/Patient Summarization/PatientSum/stanford-postagger-2014-01-04/models/english-left3words-distsim.tagger");
			PTMSum ts = new PTMSum(0.5,4);
			//clm.test();
			
			ts.clm("C:/Users/Administrator/Dropbox/Patient Summarization/Patient/Data2",tagger);
